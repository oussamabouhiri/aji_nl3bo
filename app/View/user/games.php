...
<head>
    ...
    <title>Aji L3bo - Game Catalog</title>
...
<body class="bg-background text-on-surface">
    ...
    <nav class="fixed top-0 w-full z-50 glass-nav shadow-2xl shadow-black/40">
        <div class="flex justify-between items-center px-8 py-4 max-w-full mx-auto">
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a class="font-body text-[#e9c176] border-b-2 border-[#e9c176] pb-1" href="<?= $baseUrl ?>games">Games</a>
                <a class="font-body text-[#abcdcc] hover:text-[#e9c176] transition-colors" href="<?= $baseUrl ?>reservation">My Reservations</a>
                <a class="font-body text-[#abcdcc] hover:text-[#e9c176] transition-colors" href="<?= $baseUrl ?>profile">Profile</a>
            </div>
    ...
    <main class="pt-24 pb-12 px-8 max-w-[1600px] mx-auto">
        <!-- Hero Section -->
        <section
            class="relative rounded-3xl overflow-hidden mb-12 h-[400px] flex items-center px-12 bg-surface-container-low">
            <div class="absolute inset-0 z-0">
                <img class="w-full h-full object-cover opacity-40 mix-blend-overlay"
                    data-alt="a cozy high-end board game cafe with wooden tables, soft warm lighting, and shelves full of games in a moody atmosphere"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDU6_QkNH9ngFUYpJj3R218huE0PDchBbHlnz_38aatQ31DUB2wpYpisd-8yGoU7L-m81c_wZkNbgX5X7yMvdAN0rSCpaIeSFrOSYvazR1l27FPca59QikKyzFkm1m9xABjOQPQsYz4Or_5qYFi8KagZXmY_B48_bPt7wdkRz842ekMIS-ZNRRUDkJgIC9Zx19m557x2fbY7DMoZ50dWBAt87XmPutCrzZom6x8N2XHd7Hg6vxpTcvNhw4xTnP94-e89e6udjrJBNLl">
                <div class="absolute inset-0 bg-gradient-to-r from-background via-background/60 to-transparent"></div>
            </div>
            <div class="relative z-10 max-w-2xl">
                <h1 class="font-headline text-6xl font-extrabold tracking-tight mb-4 text-on-surface">Experience <span
                        class="text-primary italic">The Digital Curator</span>
                </h1>
                ...
                <div class="sticky top-32 space-y-8">
                    ...
                    <div
                        ...
                        <div class="relative z-10">
                            <h4 class="font-headline font-bold text-primary mb-2">Host an Event?</h4>
                            <p class="text-xs text-secondary leading-relaxed mb-4">Book our VIP lounge for tournaments
                                or birthday parties.</p>
                            <button class="text-xs font-bold text-on-surface flex items-center gap-1 group">
                                Contact Concierge
                                <span
            ...
            <div class="flex-grow">
                <div class="flex justify-between items-end mb-8">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button
                            class="bg-surface-container px-4 py-2 rounded-full text-sm font-medium border border-outline-variant/10 flex items-center gap-2">
                            Popularity
    ...
    <footer class="mt-12 py-12 px-8 border-t border-outline-variant/5 bg-surface-container-lowest">
        <div class="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            <div class="col-span-1 md:col-span-1">
                <div class="text-2xl font-black tracking-tighter text-[#e9c176] font-headline mb-6">Aji L3bo</div>
                <p class="text-sm text-on-surface-variant leading-relaxed">Redefining the tabletop experience with a
                    curated selection of world-class games in an editorial atmosphere.</p>
            </div>
            <div>
                <h4 class="font-headline font-bold text-on-surface mb-6">Quick Links</h4>
            ...
            <div>
                <h4 class="font-headline font-bold text-on-surface mb-6">Visit Us</h4>
                <ul class="space-y-3 text-sm text-on-surface-variant">
            ...
            <div>
                <h4 class="font-headline font-bold text-on-surface mb-6">Join The Club</h4>
                <div class="flex gap-2">
                    <input
                        class="bg-surface-container px-4 py-2 rounded-xl border-none text-sm w-full focus:ring-1 focus:ring-primary"
        ...
        <div
            class="mt-12 pt-8 border-t border-outline-variant/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-on-surface-variant/50">
            <p>&copy; 2024 Aji L3bo Caf&eacute;. All rights reserved.</p>
