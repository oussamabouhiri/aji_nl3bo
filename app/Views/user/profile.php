...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Manrope:wght@200..800&amp;family=Inter:wght@300;400;500;600;700&amp;display=swap"
    rel="stylesheet">
  <link
...
<body class="bg-background text-on-background min-h-screen overflow-x-hidden">
  ...
  <nav
    ...
    <div class="flex items-center gap-4">
      <button
        class="material-symbols-outlined text-[#abcdcc] hover:text-[#e9c176] transition-all duration-300">notifications</button>
      <div class="w-10 h-10 rounded-full bg-surface-container-highest border border-outline-variant/15 overflow-hidden">
        <img alt="User avatar" class="w-full h-full object-cover"
          data-alt="Close-up portrait of a sophisticated man with a groomed beard wearing a dark suit in a moody, low-light studio setting"
          src="https://lh3.googleusercontent.com/aida-public/AB6AXuBNq5Gc8bNMfiHAnLMAELF-WuhD3J8OuZ1hUx4pTntuNzyfp94UUXxi58pj4Ft9cSGrMxCg5cjqxCE-766K458GW0rlNyclToEIZBGeh0eW1B0gY3JRJO_EYIU9I686q5h3D3AVSvIRr9-JJvvZ2f5Ds3OVbP6-erFTnsIzbriH5WDTVohv1-LjDut66Y4inB9jhwM5XM9tLNL2Vliupw3f6DJ_YHu5nVtQiYO-5GhaWB4L-NRAQsIGgaO15NdEekSVbmrhhxdfT3AB">
      </div>
    </div>
  </nav>
    ...
    <div class="mt-auto px-6 space-y-6">
      <div class="p-4 bg-surface-container rounded-2xl border border-outline-variant/10">
        <div class="flex items-center gap-3 mb-2">
          ...
          <span class="text-[10px] uppercase tracking-widest text-primary font-bold">Gold Tier</span>
        </div>
        <p class="text-xs text-on-surface-variant leading-relaxed">Exclusive access to the Private Archive enabled.</p>
      </div>
      <div class="space-y-1">
  ...
  <main class="lg:pl-64 pt-24 min-h-screen">
    <div class="max-w-7xl mx-auto px-6 py-8 space-y-12">
      ...
      <section
        class="relative flex flex-col md:flex-row items-end gap-8 bg-surface-container-lowest rounded-[2rem] p-8 overflow-hidden">
        <!-- Background Decorative Element -->
        <div class="absolute top-0 right-0 w-1/3 h-full opacity-10 pointer-events-none">
          <div class="absolute inset-0 brass-gradient rotate-12 translate-x-1/2 -translate-y-1/2 blur-3xl"></div>
        </div>
        <div class="relative z-10 w-40 h-40 rounded-3xl overflow-hidden shadow-2xl border-4 border-surface-container">
          <img alt="Julian Sterling" class="w-full h-full object-cover"
            data-alt="Dramatic high-contrast portrait of Julian Sterling, a stylish man with short dark hair, standing in a dim, moody study with amber light reflecting off leather-bound books"
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAWAGNfVuQ6bQw7x7LgHoYrjllhXDYi2et2BbBGpF2twmnQdycfrcNYQDEHSB9A3MhbNF59eQVU9HLpgCdmOirBYcrtjhh83F8IG2WyHSY4SYGDdkl9sREbju7kS013YCj5OGYrjeeyyrtlfkAS9Ngy3UOOSrZFItiYI1SieJ1Ti7-rvdLBYnmH_TM3DZ7zjc4xSkFVkvFzmQf3Lvu8r5gFa3fGIkZoCk026rCKIeSsfdxBw-NNdsUobx1f5XFSS4e295m189aqFtWu">
        </div>
      ...
      <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Archive Points Card -->
        <div
          class="md:col-span-2 glass-panel p-8 rounded-[2rem] border border-outline-variant/10 relative overflow-hidden flex flex-col justify-between min-h-[320px]">
        ...
        <div class="grid grid-cols-1 gap-6">
          <div class="bg-surface-container p-6 rounded-3xl flex items-center gap-5">
            <div
              class="w-12 h-12 rounded-2xl bg-secondary-container/30 flex items-center justify-center text-secondary">
          ...
          <div class="bg-surface-container p-6 rounded-3xl flex items-center gap-5">
            <div class="w-12 h-12 rounded-2xl bg-primary-container/30 flex items-center justify-center text-primary">
          ...
          <div class="bg-surface-container p-6 rounded-3xl flex items-center gap-5">
            ...
            <div>
              ...
              <p class="text-2xl font-bold font-headline text-on-surface">4 Players</p>
            </div>
          </div>
        </div>
      </section>
      <!-- 3. My Reservations Table -->
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-left">
              <thead class="bg-surface-container-high/50">
                <tr>
                  <th class="px-8 py-5 text-secondary text-xs uppercase tracking-widest font-bold">Date &amp; Time</th>
                  <th class="px-8 py-5 text-secondary text-xs uppercase tracking-widest font-bold">Game Reserved</th>
                  <th class="px-8 py-5 text-secondary text-xs uppercase tracking-widest font-bold">Party</th>
                  <th class="px-8 py-5 text-secondary text-xs uppercase tracking-widest font-bold">Status</th>
                  <th class="px-8 py-5 text-secondary text-xs uppercase tracking-widest font-bold text-right">Action
                  </th>
                </tr>
              </thead>
              <tbody class="divide-y divide-outline-variant/10">
                <tr class="hover:bg-surface-container-highest/30 transition-colors">
                  <td class="px-8 py-6">
                    <p class="text-on-surface font-bold">Dec 14, 2023</p>
                    <p class="text-on-surface-variant text-xs italic">19:30 - 22:00</p>
                  </td>
                  <td class="px-8 py-6">
                    <div class="flex items-center gap-3">
                      <div class="w-10 h-10 rounded-lg bg-surface-container-highest overflow-hidden">
                        <img alt="Gloomhaven" class="w-full h-full object-cover"
                          data-alt="Dramatic close-up of a fantasy board game piece on a dark, weathered wood table with warm lantern light casting long shadows"
                          src="https://lh3.googleusercontent.com/aida-public/AB6AXuAOhMlXYPa-IZESQ0VEThOItHCbDijtbLDbwf8XO7NH8exjSad8jy1QXHFh8moJq9w4N1-xHCMqJv8sRZsudmGHnCiCIaYyijB9EVOyMM8NhmFQc2LamFBa5OUgue-wLNhg7r7oKmTfA_ubLEQdHTaz8WgK46JD_REYqM7uf6V17yEkcAHeZg2Irbs4Ye--B8HiaIujllSh2oFZWHMN6RvC27UiLbd6f9MX08gnyebVRVPeQmI58KQbfhXUkOrpIc7R8epaDykAsRKM">
                      </div>
                      <span class="text-on-surface font-medium">Gloomhaven: Jaws of the Lion</span>
                    </div>
                  </td>
                  <td class="px-8 py-6">
                    <span class="text-on-surface-variant">4 People</span>
                  </td>
                  <td class="px-8 py-6">
                    <div class="flex items-center gap-2">
                      <div class="w-2 h-2 rounded-full bg-[#10b981] shadow-[0_0_8px_#10b981]"></div>
                      <span class="text-sm text-on-surface">Confirmed</span>
                    </div>
                  </td>
                  <td class="px-8 py-6 text-right">
                    <button
                      class="material-symbols-outlined text-secondary opacity-50 hover:opacity-100 transition-opacity">more_vert</button>
                  </td>
                </tr>
                <tr class="hover:bg-surface-container-highest/30 transition-colors">
                  <td class="px-8 py-6">
                    <p class="text-on-surface font-bold">Dec 08, 2023</p>
                    <p class="text-on-surface-variant text-xs italic">14:00 - 16:30</p>
                  </td>
                  <td class="px-8 py-6">
                    <div class="flex items-center gap-3">
                      <div class="w-10 h-10 rounded-lg bg-surface-container-highest overflow-hidden">
                        <img alt="Chess" class="w-full h-full object-cover"
                          data-alt="Elegant macro shot of a black marble chess piece on a polished dark surface with a single spotlight illuminating the texture"
                          src="https://lh3.googleusercontent.com/aida-public/AB6AXuApuy2L0Eg_sxmdTT_Q6mWHSyzUbgfAJ68q_kEjkQJkEZw6zrmr6eSEru_nqYZepgHeNHchj8Gkawi-YKkYkac_A_ziLFTfXrvyK7rKzhPWui4SLSEAC3xe3ZSRNrmB8H33LUIK_Grmp9bmPh0kcbSjI79r7khS1sq9MCaGQ9JhjM0CC-2P4Z0frhWgZ5uHn7PNmDIGf7MY6FNg0tXBNAakUES5bcUjEoZEE1XV0-LxNXdbtH3m1RQw6LJhbqjDT7NorZvYSJ7WQdQ3">
                      </div>
                      <span class="text-on-surface font-medium">Grandmaster Chess Suite</span>
                    </div>
                  </td>
                  <td class="px-8 py-6">
                    <span class="text-on-surface-variant">2 People</span>
                  </td>
                  <td class="px-8 py-6">
                    <div class="flex items-center gap-2">
                      <div class="w-2 h-2 rounded-full bg-secondary shadow-[0_0_8px_#abcdcc]"></div>
                      <span class="text-sm text-on-surface opacity-70">Completed</span>
                    </div>
                  </td>
                  <td class="px-8 py-6 text-right">
                    <button
                ...
                <tr class="hover:bg-surface-container-highest/30 transition-colors">
                  <td class="px-8 py-6">
                    <p class="text-on-surface font-bold">Nov 29, 2023</p>
                    <p class="text-on-surface-variant text-xs italic">20:00 - 00:00</p>
                  </td>
                  <td class="px-8 py-6">
                    <div class="flex items-center gap-3">
                      <div class="w-10 h-10 rounded-lg bg-surface-container-highest overflow-hidden">
                        <img alt="Catan" class="w-full h-full object-cover"
                          data-alt="Close up of hexagonal wooden board game tiles arranged on a dark surface, highlighting the geometric patterns and natural wood grain"
                          src="https://lh3.googleusercontent.com/aida-public/AB6AXuD54botTGKLheis2th6p9CfjOQg08XuQrq20RcCZb1z9eX68MznkxRjYezTT7XRqlhzsclLYmGRh14qfOfugGlCjGr2fOjPkXbeazfwQ1nkUg_TrFJuhBl54OWeIN3oY-EghvLaU17jEbLo6QBDcn758hTEXdgcwjyRDX8HuzLzleVz26lcfjIJAB7oXlWQ9W364pceU5rrvZRbJTAavphf5dWT_QORhAXJqpgxJ0EubQ2dNAf8s0GyriGJEDf80U8qFpM_uNL8g72m">
                      </div>
                      <span class="text-on-surface font-medium">Settlers of Catan: 5-6 Expansion</span>
                    </div>
                  </td>
                  <td class="px-8 py-6">
                    <span class="text-on-surface-variant">6 People</span>
                  </td>
                  <td class="px-8 py-6">
                    <div class="flex items-center gap-2">
                      <div class="w-2 h-2 rounded-full bg-secondary shadow-[0_0_8px_#abcdcc]"></div>
      ...
      <section class="grid grid-cols-1 md:grid-cols-3 gap-6 pb-12">
        <button
          ...
          <div class="flex items-center justify-between mb-4">
            ...
            <span
              class="material-symbols-outlined text-on-surface-variant group-hover:translate-x-1 transition-transform">arrow_forward_ios</span>
          </div>
  ...
  <!-- Footer Space -->
  <footer class="lg:pl-64 py-12 px-8 border-t border-outline-variant/5">
